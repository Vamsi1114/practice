...
#login_test cretaing a new user
@pytest.fixture
def test_user(client):
    user_data = {"email":"vamsi@gmail.com","password":"password123"}
...
def test_user2(client):
    user_data = {"email":"vamsi123@gmail.com","password":"password123"}
    res = client.post("/users/",json = user_data)
    assert res.status_code == 201
    # print(res.json())
    new_user = res.json()
...
def test_posts(test_user,session,test_user2):
   ...
   #creating a functon to covert dict to post model type
